                  ...
                  {healthPaged.map((s) => {
                    ...
                    return (
                      <tr key={s.name}>
                        ...
                        <td style={{ textAlign: "center" }}><button className="btn-icon danger" onClick={() => deleteSku(s.name)} title="Delete SKU"><i className="ph ph-trash" /></button></td>
                      </tr>
                    );
                  })}
                </tbody>
          ...
          <div className="settings-stack">
            ...
            {isAdmin && (
              <div className="card" style={{ padding: 0, overflow: "hidden" }}>
                ...
                <div className="table-responsive">
                  <table className="modern-data-table">
                    <thead><tr><th style={{ width: 50 }}>ID</th><th>Username</th><th>{t("email_label")}</th><th>Role</th><th>Status</th><th style={{ textAlign: "center", width: 100 }}>{t("tbl_action")}</th></tr></thead>
                    <tbody>
                      {data?.users.map((u) => (
                        <tr key={u.id}>
                          ...
                          <td style={{ textAlign: "center" }}><button className="btn-icon danger" onClick={() => deleteUser(u.id, u.username)} title="Delete Account"><i className="ph ph-trash" /></button></td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
    ...
    <div className="modal-overlay show">
      <div className="modal-content" style={{ maxWidth: 700 }}>
        ...
        <div className="table-responsive" style={{ maxHeight: 300 }}>
          <table className="modern-data-table">
            <thead><tr><th>{t("inc_date")}</th><th style={{ textAlign: "right" }}>{t("qty_in")}</th><th style={{ textAlign: "right" }}>{t("qty_used")}</th><th style={{ textAlign: "right" }}>{t("rem_sisa")}</th><th style={{ textAlign: "center" }}>{t("tbl_action")}</th></tr></thead>
            <tbody>
              {sorted.length === 0 ? (
